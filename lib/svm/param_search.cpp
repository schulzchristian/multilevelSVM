...
std::vector<std::pair<float,float>> param_search::mlsvm_method(float c_from, float c_to, float g_from, float g_to, bool step1, bool inherit, float param_c, float param_g) {
        std::vector<std::pair<float,float> > seq;
